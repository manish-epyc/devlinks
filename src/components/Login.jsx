...
function Login() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-4">
      ...
      {errors.serverError && (
        <div className="fixed top-6 left-1/2 -translate-x-1/2 flex items-center gap-2 px-4 py-4 rounded-lg bg-red-600 text-white text-sm shadow-lg animate-fade-in-out z-50">
          <svg
            className="h-5 w-5 mr-2"
            fill="none"
            stroke="currentColor"
      ...
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md text-center">
        ...
        <form
          className="mt-10"
          onSubmit={(e) => {
            clearErrors("serverError"); // clear first
            handleSubmit(onSubmit)(e); // then submit
          }}
        >
